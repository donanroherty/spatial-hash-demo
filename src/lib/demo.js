...
export default function buildSpatialHashExampleScene(canvas, cellSize = 40, numItems = 1000) {
  const ctx = canvas.getContext("2d")
  scaleCanvasToPixelRatioAndParent(canvas)

  // create a grid that fills the canvas
  const grid = createSpatialHashSystem(canvas.offsetWidth, canvas.offsetHeight, cellSize)
